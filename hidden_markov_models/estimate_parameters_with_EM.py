...
def do_expectation_scaled(X, alpha_head, beta_head, cs, means_est, covars_est, trans_mat_est, n_timesteps, n_states):
...
def do_expectation_maximization(X, n_states, max_iter=200, tol=1e-8, printing=False):
    convergence = False
    p_x_log_old = np.inf
    ...
    for iteration in range(max_iter):
        ...
        gamma, xi, log_p_x = do_expectation_scaled(X, alpha_head, beta_head, cs, means_est, covars_est, trans_mat_est,
...
if __name__ == '__main__':
    ...
    start_prob_est, trans_mat_est, means_est, covars_est = do_expectation_maximization(X, n_states,
